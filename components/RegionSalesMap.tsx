    ...
    <div className="flex h-screen w-full flex-col md:flex-row bg-zinc-50 dark:bg-zinc-950">
      ...
      <main className="flex-1 flex flex-col">
        <div className="flex flex-wrap items-center gap-2 border-b border-zinc-200 bg-white/80 px-4 py-2 text-xs dark:border-zinc-800 dark:bg-zinc-900/80 md:px-6">
          ...
          {isPending && <span className="ml-2 text-[11px] text-zinc-400">로딩 중…</span>}
          <button
            type="button"
            onClick={handleGenerateReport}
            disabled={reportPending}
            className="ml-auto rounded-full bg-violet-600 px-3 py-1.5 text-xs font-medium text-white hover:bg-violet-700 disabled:opacity-50"
          >
            {reportPending ? "리포트 생성 중…" : "일일 AI 리포트"}
          </button>
        </div>
        ...
        <div className="relative flex-1">
          ...
          {/* 지도 위 선택 지점 일별 판매 패널 */}
          {selectedMapStoreId && (
            <div className="pointer-events-auto absolute right-3 top-3 z-[500] w-64 rounded-xl border border-zinc-200 bg-white/95 p-3 text-xs shadow-lg backdrop-blur dark:border-zinc-700 dark:bg-zinc-900/95">
              ...
              <div className="mb-1 text-[11px] text-zinc-500 dark:text-zinc-400">
                마커 클릭 후 날짜를 선택해 해당 일 판매를 확인·수정·삭제할 수 있습니다.
              </div>
              <div className="mt-1 text-[11px] font-medium text-amber-800 dark:text-amber-200">
                {summaries.find((s) => s.store.id === selectedMapStoreId)?.store
                  .name ?? "지점"}
              </div>
              <div className="mt-2">
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-zinc-300 bg-white py-1.5 px-2 text-[11px] text-zinc-900 focus:border-amber-500 focus:outline-none focus:ring-1 focus:ring-amber-500 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-100"
                />
              </div>
              <div className="mt-2 min-h-[1.3rem] text-[11px]">
                {detailLoading ? (
              ...
              <div className="mt-2">
                ...
                <input
                  ...
                  placeholder="예: 120"
                  className="w-full rounded-lg border border-zinc-300 bg-white py-1.5 px-2 text-[11px] text-zinc-900 placeholder-zinc-400 focus:border-amber-500 focus:outline-none focus:ring-1 focus:ring-amber-500 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-100"
                />
              </div>
              <div className="mt-2 flex items-center justify-between gap-2">
                <button
                  ...
                  className="flex-1 rounded-lg bg-amber-500 py-1.5 text-center text-[11px] font-semibold text-white hover:bg-amber-600"
                >
                  수정 저장
                </button>
                <button
                  ...
                  className="flex-1 rounded-lg border border-red-500 py-1.5 text-center text-[11px] font-semibold text-red-600 hover:bg-red-50 dark:border-red-400 dark:text-red-300 dark:hover:bg-red-950/30"
                >
                  삭제
                </button>
              </div>
